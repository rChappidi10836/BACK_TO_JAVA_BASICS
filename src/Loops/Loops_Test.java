...
public class Loops_Test {
    ...
    public boolean findPrimeorNot(int n) {
         ...
         * for example if we check is 36 is divisible by 2 or not then we are automatically checking if 18 is divisible or not too
...
//    static void findPrimes1toN(int N){
//        int[] arr= new int[];
//        for(int i=1;i<=N;i++){
//
//        }
//    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1 is prime? " + O.findPrimeorNot(1));


        //factorial

        System.out.println("\n5! = "+findFactorial(5));
        System.out.println("1! = "+findFactorial(1));
        System.out.println("0! = "+findFactorial(0));
        System.out.println("10! = "+findFactorial(10));
        System.out.println("555367! = "+findFactorial(555367));
    }
}
